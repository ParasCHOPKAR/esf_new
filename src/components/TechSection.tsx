    ...
    return (
        <div ref={container} className="relative bg-[#0b0b0b] text-white py-20 overflow-hidden min-h-[120vh]">
            ...
            <div className="relative z-10 px-6 md:px-20 mb-16 md:mb-24 text-center">
                <span className="text-[#28a745] font-mono tracking-[0.2em] text-xs md:text-sm uppercase font-bold block mb-4">
                    Expertise & Knowledge
                </span>
                <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter leading-none relative z-20">
                    Training <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-500 to-white">Campaigns</span>
                </h2>
                
                {/* Background Giant Text */}
                <h1 
                    ref={textRef} 
                    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[12vw] md:text-[8vw] font-black text-white/5 leading-none whitespace-nowrap select-none tracking-tighter pointer-events-none z-0"
                >
                    EDUCATION
                </h1>
            </div>
